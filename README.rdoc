...
This is a modified version of jQuery alerts from Cory S.N. LaViska
...
Copy and include the .js and .css files
...
== Usage
  ...
  jConfirm('Sure ?', 'Yes dude', 'Nope', function(){
   // ...
  });
...
Reseased under MIT License as the original source